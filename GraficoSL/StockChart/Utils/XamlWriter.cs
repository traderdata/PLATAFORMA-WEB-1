...
namespace SilverlightContrib.Xaml
{
      ...
      : IDisposable
  {
    ...
    public bool WriteElement(object el)
    {
      ...
      {
        WriteAttribute("Canvas.Esquerda", Canvas.GetLeft(element), 0);
    ...
    private void WriteInnerElement(Shape shape, string typeName)
    {
      ...
      if (polygon != null)
      {
        ...
        WriteAttribute("Pontos", polygon.Points);
        goto End;
      }
