...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_OnBalanceVolume()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.OnBalanceVolume, typeof(OnBalanceVolume),
                                  "On Balance Volume",
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class OnBalanceVolume : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.OnBalanceVolume;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Série 1 não pode ser igual a série 2 para o indicador On Balance Volume. A série 2 precisa ser a série de volume.", ErroIndicador.Serie1IgualSerie2);
                return false;
            }
