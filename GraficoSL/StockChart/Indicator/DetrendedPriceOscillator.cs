...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_DetrendedPriceOscillator()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.OsciladorDetrendedPrice, typeof(DetrendedPriceOscillator),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class DetrendedPriceOscillator : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.OsciladorDetrendedPrice;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Oscilador Detrended Price.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
            EnumGeral.IndicatorType param2 = (EnumGeral.IndicatorType)ParamInt(2);
            if (param2 < Constants.MA_START || param2 > Constants.MA_END)
            {
                DisparaErroIndicador("Tipo de média móvel inválido para o indicador Oscilador Detrended Price.", ErroIndicador.TipoMediaMovelInvalida);
                return false;
            }
