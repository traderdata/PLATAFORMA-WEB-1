...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_PrimeNumberOscillator()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.OsciladorNumerosPrimos, typeof(PrimeNumberOscillator),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class PrimeNumberOscillator : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.OsciladorNumerosPrimos;
