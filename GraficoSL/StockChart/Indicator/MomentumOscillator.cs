...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_MomentumOscillator()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.OsciladorMomentum, typeof(MomentumOscillator),
                                  "Momentum Oscillator",
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class MomentumOscillator : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.OsciladorMomentum;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Oscilador Momentum.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
