...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_PriceROC()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.PriceROC, typeof(PriceROC),
                                  "Price ROC",
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class PriceROC : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.PriceROC;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Price ROC.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
