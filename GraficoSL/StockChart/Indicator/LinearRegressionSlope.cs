...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_LinearRegressionSlope()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.RegressaoLinearSlope, typeof(LinearRegressionSlope),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class LinearRegressionSlope : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.RegressaoLinearSlope;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Regressão Linear Slope (2 no mínimo).\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
