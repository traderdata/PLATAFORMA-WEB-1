...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_VariableMovingAverage()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.MediaMovelVariavel, typeof(VariableMovingAverage),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class VariableMovingAverage : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.MediaMovelVariavel;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Média Móvel Variável.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
