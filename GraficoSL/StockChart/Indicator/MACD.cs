...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    ...
    {
        RegisterIndicatorParameters(EnumGeral.IndicatorType.MACD, typeof(MACD),
                                  "MACD",
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class MACD : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.MACD;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador MACD.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
            ...
            IndicadorSerieFilha sSignal = (IndicadorSerieFilha)EnsureSeries(FullName + " Sinal");
            sSignal.SetStrokeColor(CorSerieFilha1, false);
            sSignal.SetStrokeThickness(GrossuraSerieFilha1, false);
            sSignal.SetStrokePattern(TipoLinhaSerieFilha1, false);
            sSignal.IsSerieFilha = true;
            sSignal.SeriePai = this;

            if (this.SeriesFilhas == null)
                this.SeriesFilhas = new List<Series>();

            this.SeriesFilhas.Add(sSignal);
            ...
            for (int n = 0; n < iSize; ++n)
            {
                ...
                sSignal.AppendValue(DM.TS(n), n < paramInt1 + paramInt2 ? null : pInd.Value(FullName + "Sinal", n + 1));
            }
