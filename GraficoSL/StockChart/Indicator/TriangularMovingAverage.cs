...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_TriangularMovingAverage()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.MediaMovelTriangular, typeof(TriangularMovingAverage),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class TriangularMovingAverage : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.MediaMovelTriangular;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Média Móvel Triangular.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
