...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_LinearRegressionIntercept()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.RegressaoLinearIntercept, typeof(LinearRegressionIntercept),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class LinearRegressionIntercept : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.RegressaoLinearIntercept;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Regressão Linear Intercept (2 no mínimo).\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
