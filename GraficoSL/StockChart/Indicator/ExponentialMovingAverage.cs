...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_ExponentialMovingAverage()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.MediaMovelExponencial, typeof(ExponentialMovingAverage),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class ExponentialMovingAverage : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.MediaMovelExponencial;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Média Móvel Exponencial.\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
