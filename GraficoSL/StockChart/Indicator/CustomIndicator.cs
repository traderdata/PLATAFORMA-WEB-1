...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_CustomIndicator()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.CustomIndicator, typeof(CustomIndicator),
                                  "Custom Indicator",
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class CustomIndicator : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.CustomIndicator;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                AppendValue(_chartPanel._chartX.dataManager.GetTimeStampByIndex(i), args.Values[i]);
            }
        ...
        public void AddParameter(string parameterName, EnumGeral.TipoParametroIndicador parameterType, object defaultValue, Type valueType)
        {
            if (defaultValue.GetType() != valueType)
                throw new ArgumentException("Parameter type mismatch.", "valueType");

            Parameters.Add(new StockChartX_IndicatorsParameters.IndicatorParameter
                              {
