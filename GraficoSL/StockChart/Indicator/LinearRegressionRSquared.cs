...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  public static partial class StockChartX_IndicatorsParameters
  {
    internal static void Register_LinearRegressionRSquared()
    {
      ...
      */
        RegisterIndicatorParameters(EnumGeral.IndicatorType.RegressaoLinearRaizQuadrada, typeof(LinearRegressionRSquared),
...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Indicators
{
    ...
    public class LinearRegressionRSquared : Indicator
    {
        ...
        {
            _indicatorType = EnumGeral.IndicatorType.RegressaoLinearRaizQuadrada;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                DisparaErroIndicador("Períodos inválidos para o indicador Regressão Linear RSqueared (2 no mínimo).\nAumente o período selecionado.", ErroIndicador.PeriodosInvalidos);
                return false;
            }
