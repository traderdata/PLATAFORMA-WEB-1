...
namespace Traderdata.Client.Componente.GraficoSL.StockChart.Exceptions
{
  /// <summary>
  ...
  public class InvalidIndicatorException : Exception
  {
    ...
    ///</summary>
    public EnumGeral.IndicatorType IndicatorType { get; private set; }
    ...
    public InvalidIndicatorException(EnumGeral.IndicatorType indicatorType)
