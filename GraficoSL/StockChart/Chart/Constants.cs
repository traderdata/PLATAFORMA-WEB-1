...
namespace Traderdata.Client.Componente.GraficoSL.StockChart
{
  ...
  internal static class Constants
  {
    ...
    public const EnumGeral.IndicatorType MA_START = EnumGeral.IndicatorType.MediaMovelSimples;
    public const EnumGeral.IndicatorType MA_END = EnumGeral.IndicatorType.MediaMovelPonderada;
