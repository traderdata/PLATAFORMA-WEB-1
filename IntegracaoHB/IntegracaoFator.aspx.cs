...
{
    public partial class IntegracaoFator : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirecionando
            string link = "https://XPTO.traderdata.com.br/DefaultGraficoIntegracao.aspx?sessid=" + stringHash + "&codcliente=" + codigoCliente + "&ativo=" + ativo;
