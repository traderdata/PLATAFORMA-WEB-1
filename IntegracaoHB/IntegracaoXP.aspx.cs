...
{
    public partial class IntegracaoXP : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirecionando
            string link = "https://xpi.traderdata.com.br/DefaultGraficoIntegracaoSTech.aspx?sessid=" + stringHash + "&codcliente=" + codigoCliente + "&ativo=" + ativo;
