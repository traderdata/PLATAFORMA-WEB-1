...
{
    public partial class IntegracaoCorval : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirecionando
            string link = "https://corval.traderdata.com.br/DefaultGraficoIntegracaoSTech.aspx?sessid=" + stringHash + "&codcliente=" + codigoCliente + "&ativo=" + ativo;
