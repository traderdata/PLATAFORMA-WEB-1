...
{
    public partial class IntegracaoVotorantimGrafico : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirecionando
            string link = "https://votorantim.traderdata.com.br/DefaultGraficoVotorantim.aspx?sessid=" + stringHash + "&codcliente=" + codigoCliente + "&ativo=" + ativo;
