...
{
    public partial class IntegracaoGraficoTraderdata : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Redirecionando
            string link = ConfigurationSettings.AppSettings["URL"] + "?sessid=" + stringHash + "&codcliente=" + codigoCliente + "&ativo=" + ativo;
