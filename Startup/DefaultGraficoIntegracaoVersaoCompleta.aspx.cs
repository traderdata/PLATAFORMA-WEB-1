...
namespace Startup
{
    public partial class DefaultGraficoIntegracaoVersaoCompleta : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            hashSHA.ComputeHash(ConvertStringToByteArray(Request["codcliente"] + "-" + DateTime.Today.ToString("dd-MM-yyyy")));
            ...
            if (Request["hashversaocompleta"] != stringHash)
            {
                Response.Write("Cliente Inválido");
            }
            else
            {
                string usr = Request["codcliente"];
