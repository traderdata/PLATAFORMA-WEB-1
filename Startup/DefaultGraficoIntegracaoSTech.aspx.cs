...
namespace Startup
{
    public partial class DefaultGraficoIntegracaoSTech : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ConfigurationSettings.AppSettings["AMBIENTE"] == "SITE")
                stringHash = sessId;
            ...
            else
            {
                ...
                Response.Write("<html><head><meta http-equiv=\"cache-control\" content=\"no-cache\" /><title>" + titulo + "</title>");
